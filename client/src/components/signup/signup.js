          ...
          <Form onSubmit={this.handleSubmit}>
            <Form.Row>
              <Form.Group controlId="formBasicName">
                <Form.Label className="InputContainer">Name *</Form.Label>
                <Form.Control
                  type="name"
              ...
              <Form.Group as={Col} controlId="formGridAccountType">
                {" "}
                <Form.Label className="InputContainer">
                  Account Type*
                </Form.Label>
                <Form.Control
                  as="select"
            ...
            <Form.Row>
              <Form.Group as={Col} controlId="formGridEmail">
                <Form.Label className="InputContainer">Email *</Form.Label>
                <Form.Control
                  type="email"
            ...
            <Form.Row>
              <Form.Group as={Col} controlId="formGridTypeID">
                <Form.Label className="InputContainer">Type of ID *</Form.Label>
                <Form.Control
                  type="typeID"
            ...
            <Form.Row>
              ...
              <Form.Group as={Col} controlId="formGridFaxNumber">
                <Form.Label className="InputContainer">Fax Number *</Form.Label>
                <Form.Control
                  type="faxNumber"
            ...
            <Form.Row>
              ...
              <Form.Group as={Col} controlId="formGridCapital">
                <Form.Label className="InputContainer">Capital</Form.Label>
                <Form.Control
                  type="capital"
